...
const Checkout = () => {
  ...
  const applyCoupon = () => {
    ...
    if (subtotal < coupon.amount) {
      setError(
        `Coupon is valid only for orders above ₹${coupon.amount.toFixed(2)}`
      );
      toast.error(
        `Coupon is valid only for orders above ₹${coupon.amount.toFixed(2)}`
      ); // Show error message
  ...
  const validateFields = (address) => {
    ...
    Object.entries(address).forEach(([key, value]) => {
      if (!value.trim()) {
        ...
        if (
          (key === "firstName" || key === "lastName" || key === "city") &&
          ...
          handler: async function (response) {
            ...
            if (result.success) {
              ...
              navigate("/order-confirmation", {
                state: { uniqueOrderId, orderDetails },
              });
            } else {
        ...
        <div className="grid-container">
            ...
            <section className="section">
              ...
              <form className="custom-checkout-form" onSubmit={handleSubmit}>
                ...
                <div className="custom-form-row">
                  <div
                    className={`custom-form-group ${getFieldError(
                      "firstName"
                    )}`}
                  >
                  ...
                  <div
                    className={`custom-form-group ${getFieldError("lastName")}`}
                  >
                ...
                <div className="custom-form-row">
                  ...
                  <div
                    className={`custom-form-group ${getFieldError("state")}`}
                  >
                  ...
                  <div
                    className={`custom-form-group ${getFieldError("zipCode")}`}
                  >
                ...
                {!useSameAddress && (
                  <div className="billing-address">
                    ...
                    <div className="custom-form-row">
                      <div
                        className={`custom-form-group ${getFieldError("city")}`}
                      >
                        <label className="custom-form-label">City</label>
                        <input
                          type="text"
          ...
          <div className="lg:col-span-1">
            <div className="order-summary-container">
              ...
              {cartItems.map((item) => (
                <div className="order-item">
                  ...
                  <div className="order-item-details">
                    ...
                    <p className="i">Item Code:{item.itemcode}</p>
              ...
              {error && (
                <p style={{ color: "red", padding: "0px 8px 8px 5px" }}>
                  {error}
                </p>
              )}
              <div className="promo-container">
                ...
                />
                <button onClick={applyCoupon} className="promo-button">
                  Apply
                </button>
              </div>
              ...
              <div className="price-summary-container">
                ...
                <div className="price-summary-item">
                  <span className="price-summary-text">
